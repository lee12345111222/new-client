...
const RepliedDetailSec: FC<RepliedDetailSecProps> = ({
    replied,
        ...
        <div className="message-list-replied-section">
            <div className="message-list-replied-section-body">
                <div className="message-list-replied-section-img-container">
                    <img
                        src={replied.repliedAvatar}
                        alt={replied.repliedAvatar}
                    />
                </div>
                <div className="message-list-replied-section-content-container">
                    <div className="message-list-replied-section-name">
                        {replied.repliedName}
                    </div>
                ...
                <button
                    className="message-list-replied-section-close-btn"
                    onClick={handleRepliedDetailClose}
                >
                    {icons.close()}
                </button>
            </div>
