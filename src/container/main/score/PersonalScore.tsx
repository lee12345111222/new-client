        ...
        <div className="score-wrap">
            <div className="score-user-info">
                <div className="score-user-info-energy-bar">
                    <img
                        src={`https://oss.uppmkt.com/cxo/img/energy/Value-${~~(
                            scoreDetail.score / 1000
                        )}.png`}
                        alt="energy bar"
                    />
                </div>
            ...
            >
                <Panel
                    className={
                        collapseOpened
                            ? 'score-user-awards-panel panel-open'
                            : 'score-user-awards-panel'
                    }
                    header="中奖清单"
                    key="1"
                >
                    <ul className="score-user-awards-list">
                        <li>
                            ...
                            <div>
                                {awards['pre'] ? (
                                    <span className="score-user-awards">
                                        {awards['pre'].prizeName}
                                    </span>
                                ) : (
                                    <span className="score-user-not-win">
                                        未中奖
                                    </span>
                                )}
                            </div>
